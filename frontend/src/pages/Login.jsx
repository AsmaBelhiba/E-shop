                ...
                <form onSubmit={handleSubmit} className="space-y-8 text-left">
                    ...
                    <div className="pt-4">
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-6 bg-gray-900 text-white rounded-[2rem] font-black uppercase tracking-[0.2em] text-sm hover:bg-blue-600 transition-all active:scale-95 shadow-2xl shadow-blue-100 flex items-center justify-center gap-3 group disabled:opacity-60"
                        >
                            {loading ? (
                    ...
                    <div className="text-center pt-4">
                        <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 leading-none">
                            New here?{' '}
                            <Link to="/register" className="text-blue-600 hover:underline decoration-2 underline-offset-4 decoration-blue-200">
                                Create an account
                            </Link>
                        </p>
                    </div>
